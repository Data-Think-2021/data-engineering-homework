...
(base) xia@data--engineering-demo:~/data-engineering-zoomcamp/week_1_basics_n_setup/1_terraform_gcp/terraform$ terraform apply
var.project
  Your GCP Project ID

  Enter a value: data-engineering-demo-375721
...
Terraform will perform the following actions:
  ...
  + resource "google_bigquery_dataset" "dataset" {
      ...
      + project                    = "data-engineering-demo-375721"
  ...
  + resource "google_storage_bucket" "data-lake-bucket" {
      ...
      + id                          = (known after apply)
      + location                    = "EUROPE-WEST6"
      + name                        = "dtc_data_lake_data-engineering-demo-375721"
...
╵
╷
│ Error: Error creating Dataset: googleapi: Error 409: Already Exists: Dataset data-engineering-demo-375721:trips_data_all, duplicate
│ 
